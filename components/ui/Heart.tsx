...
export default function Heart({ className = "", style, fill = "currentColor", title }: Props) {
  return (
    <svg viewBox="0 0 32 29" className={className} style={style} aria-hidden={title ? undefined : true} role={title ? "img" : undefined}>
      ...
      />
      <path fill="rgba(255,255,255,0.38)" d="M8.1 4.2c-2.2 0-3.9 1.7-3.9 3.9 0 1.1.4 2.1 1.2 2.9.5-2.5 2.1-4.4 4.8-5.3-.6-1-1.2-1.5-2.1-1.5z" />
      <path fill="rgba(90,16,40,0.28)" d="M28.5 8.3c0 5.9-6.2 8.4-12.5 17.3 7-8.1 14.7-11 14.7-17.3 0-1.2-.3-2.3-.8-3.3-.9 1-1.4 2.1-1.4 3.3z" />
    </svg>
  );
}
